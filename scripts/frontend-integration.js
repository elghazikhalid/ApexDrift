 ...
 * This file demonstrates how to integrate Apexdrift with a web frontend
 */

// For React/Vue/Angular applications
export class ApexdriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ApexdriftClient(provider, contractAddress);
